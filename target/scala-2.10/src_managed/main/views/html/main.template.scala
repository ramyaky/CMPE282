...
<html>
    ...
    <body onload="getCurrentWeather();">
        ...
        <script src=""""),_display_(Seq[Any](/*64.23*/routes/*64.29*/.Assets.at("javascripts/canvasjs.min.js"))),format.raw/*64.70*/(""""></script>
</html>
"""))}
    }
